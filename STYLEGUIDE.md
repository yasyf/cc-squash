# cc-squash Style Guide

The concrete style rules for `cc_squash/`. Target Python 3.13+.
...
if TYPE_CHECKING:
    from cc_squash.models import Record
...
def model_version() -> str:
    from cc_squash.state import RESOURCES
...
from cc_squash.matcher import Matcher
from cc_squash.runner import Runner

# Bad — redundant-alias / __all__ ceremony
from cc_squash.matcher import Matcher as Matcher
